...
function ContactForm() {
  ...
  return (
    <form className={`flex flex-col items-center text-sm ${state.textColor} mt-5   `}>
      ...
      <div className="max-w-96 w-full px-4">
        ...
        <label htmlFor="license" className="font-medium mt-4 block">
          License Type
        </label>
        <select
          id="license"
          className="mt-2 mb-4 w-full h-10 px-3 bg-transparent border border-slate-300 rounded-full outline-none focus:ring-2 focus:ring-indigo-400 transition-all"
          required
        >
